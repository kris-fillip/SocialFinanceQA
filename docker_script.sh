...
# Default values
image="kkahl/socialfinanceqa:v1"
command="bash"
gpus="none"
...
docker run --rm -it -m 256G --cpus 24 -v "$(pwd)":/workspace -v /../../scratch2/kkahl/SocialFinanceQA/data:/data/ -w /workspace --user $(id -u):$(id -g) --env XDG_CACHE_HOME --env WANDB_DATA_DIR --env WANDB_API_KEY --gpus=\"device=${gpus}\" $image $command
