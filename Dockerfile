...
RUN micromamba run -n research pip install scipy==1.14.1 --no-deps --no-cache-dir
RUN micromamba run -n research pip install rouge-score==0.1.2 --no-deps --no-cache-dir
RUN micromamba run -n research pip install absl-py==2.1.0 --no-deps --no-cache-dir
RUN micromamba run -n research pip install nltk==3.8.1 --no-deps --no-cache-dir
RUN micromamba run -n research pip install tyro==0.7.0 --no-deps --no-cache-dir
RUN micromamba run -n research pip install rich==11.1.0 --no-deps --no-cache-dir
...
RUN micromamba run -n research pip install bert_score==0.3.13 --no-deps --no-cache-dir
RUN micromamba run -n research pip install kaleido==0.2.1 --no-deps --no-cache-dir
RUN micromamba run -n research pip install strip_markdown==1.3 --no-cache-dir
RUN micromamba run -n research pip install vertexai==0.0.1 --no-cache-dir
RUN micromamba run -n research pip install jsonlines==4.0.0 --no-cache-dir
RUN micromamba run -n research pip install spacy==3.8.2 --no-cache-dir
